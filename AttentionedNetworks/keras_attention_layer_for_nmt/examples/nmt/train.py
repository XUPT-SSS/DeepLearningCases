...
# os.environ["PATH"] += os.pathsep + 'D:/DailyUse/GraphViz/bin'

project_path = os.path.sep.join(os.path.abspath(__file__).split(os.path.sep)[:-2])
if project_path not in sys.path:
    sys.path.append(project_path)

from AttentionedNetworks.keras_attention_layer_for_nmt.examples.utils.data_helper import read_data, sents2sequences
from AttentionedNetworks.keras_attention_layer_for_nmt.examples.nmt.model import define_nmt
from AttentionedNetworks.keras_attention_layer_for_nmt.examples.utils.model_helper import plot_attention_weights
from AttentionedNetworks.keras_attention_layer_for_nmt.examples.utils.logger import get_logger
...
if __name__ == '__main__':
    ...
    # plot_model(full_model, to_file='model-1.png')
    # plot_model(infer_enc_model, to_file='model-2.png')
    # plot_model(infer_dec_model, to_file='model-3.png')
