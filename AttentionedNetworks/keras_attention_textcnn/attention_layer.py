...
class AttentionBeforeConvolution(Layer):
    ...
    def build(self, input_shape):
        ...
        self.attention_W = self.add_weight(shape=tf.TensorShape((input_shape[-1], self.attention_hidden_dim,)),
        ...
        self.attention_U = self.add_weight(shape=tf.TensorShape((input_shape[-1], self.attention_hidden_dim,)),
                                           initializer=self.init,
        ...
        if self.bias:
            self.b = self.add_weight(shape=tf.TensorShape((input_shape[-1],)),
                                     initializer='zero',
